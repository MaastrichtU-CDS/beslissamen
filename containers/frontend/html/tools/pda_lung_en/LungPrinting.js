...
function writePage() {
    ...
    contents +="<p id='paragraph01' style='font-family: Asap, sans-serif;'>There are two treatment options available for you. Radiotherapy in combination with chemotherapy or surgery in combination with chemotherapy.</p>";
    ...
    contents += "If you want to adapt your results now, you can change them by taking the knowledge test again, or adjusting your preferences and printing again.</p>";
